  ...
  return (
    <>
      <div className="bg-background h-screen px-7 container mx-auto">
        <div className="flex items-center pt-6 pl-6 mb-14">
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-44 ml-36">
            <div>
              ...
              >
                <div className="flex font-extralight text-white gap-6">
                  <input
                    ...
                    autoComplete="nome"
                    required
                    className="bg-background border rounded-3xl mb-7 py-3 pl-7 w-44 focus:outline-none focus:border-orange transition-all"
                  />
                  ...
                  <input
                    ...
                    required
                    className="bg-background border rounded-3xl mb-7 py-3 pl-8 w-44 focus:outline-none focus:border-orange transition-all"
                  />
                </div>

                <div
                  className="flex flex-col font-extralight text-white"
                  action="#"
                  method="POST"
                >
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="bg-background border rounded-3xl mb-4 py-3 pl-8 focus:outline-none focus:border-orange transition-all"
                  />
                  ...
                  <div className="flex flex-col leading-7 ml-2">
                    <div className="text-white font-extralight flex items-center outline-none">
                      ...
                      >
                        ...
                        <span className="text-orange underline decoration-orange">
                          {" "}
                          LaboTech
                        </span>
                      </a>
            ...
            <div className="text-orange">
              ...
              <div className="text-center mb-2">
                <p className="text-white font-extralightpt-3">
                  Nossos
                  <span className="text-orange"> Laboinstrutores </span>
