            ...
            <div>
              ...
              <form className="flex flex-col font-extralight text-orange pr-60" action="#" method="POST">
                <input type="email" name="email" placeholder="E-mail" id="email" autoComplete="email"
                 required className="bg-background border rounded-3xl mb-3 py-3 pl-8 w-96 focus:outline-none focus:border-orange transition-all"/>
              ...
              <div className="text-center font-extralight pr-60 mt-6">
